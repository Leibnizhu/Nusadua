...
/**
 * @author Leibniz on 2020/08/30 7:27 PM
 */
public class NusaduaLightModifierList extends LightModifierList implements SyntheticElement {
    ...
    public NusaduaLightModifierList(PsiManager manager, final Language language, Collection<String> implicitModifiers, String... modifiers) {
    ...
    public String toString() {
        return "NusaduaLightModifierList";
    }
    ...
    public boolean equals(Object o) {
        ...
        NusaduaLightModifierList that = (NusaduaLightModifierList) o;
